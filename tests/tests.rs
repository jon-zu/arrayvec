...
fn test_arrayvec_from_slice_const() {
    const V: ArrayVec<u8, 10> = ArrayVec::<u8, 10>::from_array_const(b"0123456789");
...
HOW to test those?
#[test]
fn test_arraystring_from_str_const_panic() {
    assert_eq!(ArrayString::<0>::from_str_const("0"), None);
    assert_eq!(ArrayString::<1>::from_str_const("01"), None);
}
*/
